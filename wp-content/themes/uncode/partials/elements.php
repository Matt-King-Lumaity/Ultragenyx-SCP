			...
			if (isset($media_attributes->metadata)) {
				...
				if ( $lbox_enhance ) {
					...
					if ( $media_attributes->post_mime_type === 'video/mp4' ) {
						$lightbox_data .= 'data-video=\'{"source": [{"src":"' . $create_link . '", "type":"video/mp4"}]}\' data-icon="video"';
