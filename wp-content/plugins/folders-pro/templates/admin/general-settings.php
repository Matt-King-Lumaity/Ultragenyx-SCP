...
<link rel='stylesheet' href='<?php echo WCP_PRO_FOLDER_URL ?>assets/css/settings.css?ver=<?php echo WCP_PRO_FOLDER_VERSION ?>' type='text/css' media='all' />
<link rel='stylesheet' href='<?php echo WCP_PRO_FOLDER_URL ?>assets/css/folder-icon.css?ver=<?php echo WCP_PRO_FOLDER_VERSION ?>' type='text/css' media='all' />
<link rel='stylesheet' href='<?php echo WCP_PRO_FOLDER_URL ?>assets/css/spectrum.min.css?ver=<?php echo WCP_PRO_FOLDER_VERSION ?>' type='text/css' media='all' />
<?php if($setting_page == "folder-settings") { ?>
    <link rel='stylesheet' href='<?php echo WCP_PRO_FOLDER_URL ?>assets/css/select2.min.css?ver=<?php echo WCP_PRO_FOLDER_VERSION ?>' type='text/css' media='all' />
    <script type="text/javascript" src='<?php echo WCP_PRO_FOLDER_URL ?>assets/js/select2.min.js?ver=<?php echo WCP_PRO_FOLDER_VERSION ?>'  />
<?php } ?>
<script src="<?php echo WCP_PRO_FOLDER_URL ?>assets/js/spectrum.min.js"></script>
<style>
            ...
            $(document).on("click", ".change-folder-user-status", function(){
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        'status': userStatus,
                        'nonce': "<?php echo wp_create_nonce("wcp_update_user_folder_status") ?>"
                    },
                    type: 'post',
            ...
            $(document).on("click", "#dynamic_folders_for_admin_only", function(){
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        'status': userStatus,
                        'nonce': "<?php echo wp_create_nonce("dynamic_folders_for_admin_only") ?>"
                    },
                    type: 'post',
                    success: function (res) {
                            ...
                            <table class="form-table">
                                <tboby>
                                                ...
                                                <td style="padding: 15px 10px 15px 0px" colspan="4">
                                                    <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                                        <label for="" class="custom-checkbox send-user-to-pro">
                                                            <input disabled type="checkbox" class="sr-only" name="default_folders[<?php echo esc_attr($post_type->label) ?>]" id="show_media_details" value="on" />
                                                            <span></span>
                                                        </label>
                                        ...
                                        <tr>
                                            <td width="20" class="no-padding">
                                                <label for="enable_media_trash" class="custom-checkbox">
                                                    <input class="sr-only" type="checkbox" id="enable_media_trash" name="customize_folders[enable_media_trash]" value="on" <?php checked($enable_media_trash, "on") ?>/>
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td colspan="3">
                                    ...
                                    <tr class="media-setting-box <?php echo (!$hasValidKey)?"active":($show_media_details == "on"?"active":"") ?> <?php echo (!$hasValidKey)?"send-user-to-pro":"" ?>" >
                                        <td colspan="4">
                                        <input type="hidden" name="folders_settings1" value="<?php echo time() ?>">
                                            <div>
                                                <div class="">
                                                    <?php
                            ...
                            <table class="form-table">
                                            ...
                                            <?php if(!$hasValidKey) { ?>
                                                ...
                                                <li>
                                                    <a class="upgrade-box-link d-block" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                                        ...
                                                        <span class="upgrade-link"><?php echo esc_html_e("Activate your license key", "folders") ?></span>
                                                    </a>
                                                </li>
                                            <?php } else { ?>
                                                <li>
                                                    <label class="color-checkbox custom-color-picker <?php echo ($custom_color)?"active":"" ?>" for="<?php echo esc_attr($field_name)."-".$key ?>">
                                                        <input type="radio" id="<?php echo esc_attr($field_name)."-".$key ?>" name="customize_folders[<?php echo esc_attr($field_name) ?>]" class="sr-only checkbox-color color-field" value="<?php echo ($custom_color)?$color:"#FA166B" ?>" <?php echo ($custom_color)?"checked":"" ?> />
                                                        <span class="color-box"><span class="color-box-area">Custom</span></span>
                                                    </label>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                ...
                                <tr>
                                    <td class="no-padding">
                                        <?php if(!$hasValidKey) { ?>
                                        <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                            <label for="bulk_organize_button_color" ><b>"Bulk Organize"</b> button color <button type="button" class="upgrade-link" ><?php esc_html_e("Activate your license key", 'folders') ?></button></label>
                                        </a>
                                        <?php } else { ?>
                                ...
                                <tr>
                                    <td class="no-padding">
                                        <?php if(!$hasValidKey) { ?>
                                        <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                            <label for="media_replace_button" ><b>"Replace File"</b> media library button <button type="button" class="upgrade-link" ><?php esc_html_e("Activate your license key", 'folders') ?></button></label>
                                        </a>
                                        <?php } else { ?>
                                            <label for="media_replace_button" ><b>"Replace File"</b> media library button </label>
                                        <?php } ?>
                                    </td>
                                    <td>
                                        <ul class="color-list">
                                ...
                                <tr>
                                    <td class="no-padding">
                                        <?php if(!$hasValidKey) { ?>
                                        <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                            <label for="dropdown_color" >Dropdown color <button type="button" class="upgrade-link" ><?php esc_html_e("Activate your license key", 'folders') ?></button></label>
                                        </a>
                                        <?php } else { ?>
                                    ...
                                    <td>
                                        <ul class="color-list">
                                            ...
                                            <?php } else { ?>
                                                <li>
                                                    <label class="color-checkbox custom-color-picker <?php echo ($custom_color)?"active":"" ?>" for="<?php echo esc_attr($field_name)."-".$key ?>">
                                                        <input type="radio" id="<?php echo esc_attr($field_name)."-".$key ?>" name="customize_folders[<?php echo esc_attr($field_name) ?>]" class="sr-only checkbox-color color-field" value="<?php echo ($custom_color)?$color:"#484848" ?>" <?php echo ($custom_color)?"checked":"" ?> />
                                                        <span class="color-box"><span class="color-box-area">Custom</span></span>
                                                    </label>
                                                </li>
                                            <?php } ?>
                                ...
                                <tr>
                                    <td class="no-padding">
                                        <?php if(!$hasValidKey) { ?>
                                        <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                            <label for="folder_bg_color" >Folders background color <button type="button" class="upgrade-link" ><?php esc_html_e("Activate your license key", 'folders') ?></button></label>
                                        </a>
                                        <?php } else { ?>
                                ...
                                <tr>
                                    <td class="no-padding">
                                        <label for="folder_font" >
	                                        <?php if($hasValidKey || ($setting_font !== false && $setting_font != "" && !in_array($setting_font, array("Arial","Tahoma","Verdana","Helvetica","Times New Roman","Trebuchet MS","Georgia")))) {
                                    ...
                                    <td colspan="2">
                                        <select name="customize_folders[folder_font]" id="folder_font" >
                                            ...
                                            foreach ($fonts as $key => $value):
	                                            ...
	                                            if($hasValidKey || (($setting_font !== false && $setting_font != "" && !in_array($setting_font, array("Arial","Tahoma","Verdana","Helvetica","Times New Roman","Trebuchet MS","Georgia"))) || $value != "Google Fonts" )) { ?>
                        ...
                        if(isset($type) && !empty($type)) {
                            switch ($type) {
                                ...
                                case "expired": ?>
                                    ...
                                    <?php break;
                                case "no_activations": ?>
                                    <div class='folder-error-message'><?php printf(esc_html__("Your license was activated for another domain, please visit your %sPremio account%s", 'folders'), '<a target="_blank" href="https://go.premio.io">', '</a>') ?></div>
                                    <?php break;
                            }
                        }
                        ?>
                            ...
                            <?php foreach ($plugin_info as $slug=>$plugin) { ?>
                                <?php if($plugin['is_exists']) { ?>
                                    <tr class="other-plugins-<?php echo esc_attr__($slug) ?>" data-plugin="<?php echo esc_attr__($slug) ?>" data-nonce="<?php echo wp_create_nonce("import_data_from_".$slug) ?>" data-folders="<?php echo esc_attr($plugin['total_folders']) ?>" data-attachments="<?php echo esc_attr($plugin['total_attachments']) ?>">
                                        ...
                                        <td>
                                            <span class="import-message"><?php printf(esc_html__("%s folder%s and %s attachment%s", "folders"), $plugin['total_folders'], ($plugin['total_folders']>1)?esc_html__("s"):"" ,$plugin['total_attachments'], ($plugin['total_attachments']>1)?esc_html__("s"):"") ?></span>
