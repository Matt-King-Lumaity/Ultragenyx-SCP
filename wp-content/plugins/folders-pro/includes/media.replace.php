...
class foldersPro_replace_media {
    ...
    public $replace_media_title = false;
...
//
        ...
        if(isset($_GET['image_update']) && isset($_GET['premio_message']) && $_GET['premio_message'] == "success") {
    ...
    public function change_file_name_with_title($post_id = 0) {
        ...
        if($new_file_name != $file_name) {
            ...
            if(file_exists($this->old_file_path)) {
                ...
                $update_array['post_title'] = $_REQUEST['post_title'];
    ...
    public function change_file_name_on_update($post_id = 0) {
        ...
        $premio_change_file_name = $_REQUEST['premio_change_file_name'];
    ...
    public function folders_admin_css_and_js($page) {
        if($page == "media_page_folders-replace-media" || $page == "admin_page_folders-replace-media") {
            ...
            wp_enqueue_script('folders-replace-media', plugin_dir_url(dirname(__FILE__)) . 'assets/js/replace-media.min.js', array(), WCP_PRO_FOLDER_VERSION);
    ...
    public function change_file_name_box($post) { ?>
        <p>
            <input type="hidden" name="premio_change_nonce" value="<?php echo wp_create_nonce("premio_change_file_name_".$post->ID) ?>">
