...
class folders_pro_review_box {
    ...
    public function admin_notices() {
        if (current_user_can('manage_options')) {
            ...
            <div
                class="notice notice-info premio-notice <?php echo $this->plugin_slug ?>-premio-review-box <?php echo $this->plugin_slug ?>-premio-review-box">
                <div class="review-box-default" id="default-review-box-<?php echo $this->plugin_slug ?>">
                    <p>
                        ...
                        that's pretty awesome! Can you please show us some love and
                        rate <?php echo $this->plugin_name ?> on WordPress? It'll only take 2 minutes of your time, and
                        will really help us spread the word
                        - <b>Gal Dubinski</b>, Co-founder <img width="30px"
                                                               src="<?php echo esc_url(plugin_dir_url(__FILE__) . "../assets/images/premio-owner.jpg") ?>"/>
                        <a href="javascript:;"
                    ...
                    <ul>
                        <li><a class="<?php echo $this->plugin_slug ?>-premio-review-box-hide-btn"
                               href="https://wordpress.org/support/plugin/folders/reviews/?filter=5" target="_blank">I'd
                                love to help :)</a></li>
                        <li><a class="<?php echo $this->plugin_slug ?>-premio-review-box-future-btn"
                ...
                <div class="review-thanks-box" id="review-thanks-<?php echo $this->plugin_slug ?>">
                    ...
                    <div class="review-thanks-img">
                        <img width="30px"
                             src="<?php echo esc_url(plugin_dir_url(__FILE__) . "../assets/images/thanks.gif") ?>"/>
                    </div>
