    ...
    function($) {
        ...
        void 0 === window.vc && (window.vc = {}), window.vc.ShortcodesBuilder = function(models) {
            ...
            save: function(status) {
                ...
                data.vc_post_custom_css = window.vc.$custom_css.val(), data.content = this.wpautop(string), status && (data.post_status = status, $(".vc_button_save_draft").hide(100), $("#vc_button-update").text(window.i18nLocale.update_all)), window.vc.update_title && (data.post_title = this.getTitle()), this.ajax(data).done(function() {
    ...
    function($) {
        ...
        window.vc.cloneMethod_vc_tab = function(data, model) {
            ...
            updated: function() {
                ...
                // END UNCODE EDIT
                window.InlineShortcodeView_vc_tabs.__super__.updated.call(this), this.$tabs.find(".wpb_tabs_nav:first").remove(), window.vc.frame_window.vc_iframe.buildTabs(this.$tabs), this.setSorting()
            },
            rowsColumnsConverted: function() {
            ...
            buildControlHtml: function(model) {
                ...
                var tab_id = model.get("cloned") ? model.attributes.params.slug + "_cloned" : 'tab-' + model.getParam("tab_id");
                var $tab = $('<li data-tab-id="' + tab_id + '" data-tab-o-id="' + model.getParam("tab_id") + '" class="vc_tta-tab' + active + '"><a href="#' + tab_id + '" data-toggle="tab"><span></span></a></li>');
                // $tab.find("> a > span i.fa").remove();
                return $tab.data("model", model).attr('data-m-id', model.get("id")), $tab.find("> a > span").text(model.getParam("title")).prepend(icon_left).append(icon_right), $tab
                // END UNCODE EDIT
            },
            addElement: function(e) {
